...
export class Vacancy {
  ...
  @ApiProperty({
    example:
      'Efficitur malesuada pellentesque velit lacinia morbi amet, ornare orci, sed nulla faucibus. Sapien dui pulvinar nulla sed morbi mattis non vel mattis integer et. Est. Odio. Pellentesque lectus in imperdiet sodales sapien imperdiet morbi lectus mattis ornar',
  ...
  @ApiProperty({
    example: false,
    description: 'Is this vacancy closed for applicants',
  })
  @Column({ default: false })
